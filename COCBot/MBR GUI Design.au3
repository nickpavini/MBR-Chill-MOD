...
Global $g_hTabMain = 0, $g_hTabLog = 0, $g_hTabVillage = 0, $g_hTabAttack = 0, $g_hTabBot = 0, $g_hTabAbout = 0, $g_hTabMOD = 0 ; Chill MOD
...
;~ ------------------------------------------------------
	...
	$g_hTabMOD = GUICtrlCreateTabItem(GetTranslatedFileIni("MBR Main GUI", "Tab_10", "MOD")) ; Chill MOD
...
;~ -------------------------------------------------------------
	...
	Static $g_hGUI_MOD_TAB_ImageList = 0 ; Chill MOD
	...
	Bind_ImageList($g_hGUI_MOD_TAB, $g_hGUI_MOD_TAB_ImageList) ; Chill MOD
