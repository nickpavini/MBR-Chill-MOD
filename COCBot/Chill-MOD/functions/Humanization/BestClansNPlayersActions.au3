...
Func LookAtBestClans()
	...
	If IsClanOverview() Then
		Click(360, 80 + $g_iMidOffsetY) ; open best clans menu
		randomSleep(3000)
		...
		If IsBestClans() Then
			...
			Switch $PlayerList
				Case 1
					Click(270, 140 + $g_iMidOffsetY) ; look at global list
					Click(580, 330 + $g_iMidOffsetY + (52 * Random(0, 6, 1)))
				Case 2
					Click(640, 140 + $g_iMidOffsetY) ; look at local list
					Click(580, 190 + $g_iMidOffsetY + (52 * Random(0, 9, 1)))
			EndSwitch
			...
			If QuickMIS("BC1", $g_sImgHumanizationWarLog) Then
				...
				Click(100, 340 + $g_iMidOffsetY) ; open war log if available
				randomSleep(1500)
				...
				Click(50, 80 + $g_iMidOffsetY) ; click Return
			EndIf
