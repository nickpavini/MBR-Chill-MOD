...
Func WatchDefense()
	...
	If IsMessagesReplayWindow() Then
		Click(190, 130 + $g_iMidOffsetY) ; open defenses tab
		randomSleep(1500)

		If IsDefensesTab() Then
			Click(710, (230 + $g_iMidOffsetY + (145 * Random(0, 2, 1)))) ; click on a random replay
			WaitForReplayWindow()
...
Func WatchAttack()
	...
	If IsMessagesReplayWindow() Then
		Click(380, 130 + $g_iMidOffsetY) ; open attacks tab
		randomSleep(1500)
